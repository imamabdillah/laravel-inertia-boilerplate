...
export default function MitraProfilEdit({
    mitra,
    dokumen_wajib,
    tag_options,
}: Props) {
    ...
    const uptLabels = Object.fromEntries(
        tag_options.upt.map((o) => [o.value, o.label]),
    );
    ...
    if (!mitra.is_profile_complete) {
        missingItems.push(
            'Lengkapi data profil (field wajib belum semua terisi)',
        );
    }
    ...
    const canEdit = !['menunggu_verifikasi', 'diverifikasi', 'aktif'].includes(
        mitra.status,
    );
    ...
    return (
        <AdminLayout breadcrumbs={breadcrumbs}>
            <div className="mx-auto flex w-full max-w-7xl flex-2 flex-col gap-6 p-4 md:p-6">
                {/* Header */}
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        <h1 className="text-2xl font-bold">Profil Mitra</h1>
                        <p className="mt-1 text-sm text-muted-foreground">
                            Lengkapi data lembaga untuk proses kerjasama
                        </p>
                    </div>
                    <Badge
                ...
                <form onSubmit={handleSave} className="flex flex-col gap-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Informasi dasar tentang lembaga Anda
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            {data.jenis_lembaga === 'lainnya' && (
                                <div className="grid gap-1.5">
                                    <Label htmlFor="jenis_lembaga_lainnya">
                                        Sebutkan Jenis Lembaga{' '}
                            ...
                            <div className="grid gap-1.5">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setData('bidang_kerja', e.target.value)
                                    }
                                    disabled={!canEdit}
                                />
                                {errors.bidang_kerja && (
                        ...
                        <CardContent className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div className="grid gap-1.5">
                                ...
                                <Input
                                    id="email_lembaga"
                                    type="email"
                                    value={data.email_lembaga}
                                    onChange={(e) =>
                                        setData('email_lembaga', e.target.value)
                                    }
                                    disabled={!canEdit}
                                />
                                {errors.email_lembaga && (
                                    <p className="text-xs text-destructive">
                                        {errors.email_lembaga}
                                    </p>
                                )}
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Penanggung jawab yang bisa dihubungi
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                            <div className="grid gap-1.5">
                                <Label htmlFor="pic_nama">
                                    Nama PIC{' '}
                                    <span className="text-destructive">*</span>
                                </Label>
                                <Input
                                    ...
                                    value={data.pic_nama}
                                    onChange={(e) =>
                                        setData('pic_nama', e.target.value)
                                    }
                                    disabled={!canEdit}
                                />
                                {errors.pic_nama && (
                            ...
                            <div className="grid gap-1.5">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setData('pic_jabatan', e.target.value)
                                    }
                                    disabled={!canEdit}
                                />
                                {errors.pic_jabatan && (
                            ...
                            <div className="grid gap-1.5">
                                <Label htmlFor="pic_telepon">
                                    Telepon PIC{' '}
                                    <span className="text-destructive">*</span>
                                </Label>
                                <Input
                                    id="pic_telepon"
                                    value={data.pic_telepon}
                                    onChange={(e) =>
                                        setData('pic_telepon', e.target.value)
                                    }
                                    disabled={!canEdit}
                                />
                                {errors.pic_telepon && (
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Nomor dokumen legalitas (opsional, bisa diisi
                                nanti)
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-4 md:grid-cols-3">
                            <div className="grid gap-1.5">
                                <Label htmlFor="nomor_akta">
                                    Nomor Akta Pendirian / SK
                                </Label>
                                <Input
                                    id="nomor_akta"
                                    value={data.nomor_akta}
                                    onChange={(e) =>
                                        setData('nomor_akta', e.target.value)
                                    }
                                    disabled={!canEdit}
                                />
                            </div>
                            <div className="grid gap-1.5">
                                ...
                                <Input
                                    id="nomor_nib"
                                    value={data.nomor_nib}
                                    onChange={(e) =>
                                        setData('nomor_nib', e.target.value)
                                    }
                                    disabled={!canEdit}
                                />
                            </div>
                            <div className="grid gap-1.5">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setData('nomor_npwp', e.target.value)
                                    }
                                    disabled={!canEdit}
                                />
                            </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Dokumen berikut harus diupload sebelum bisa submit
                        </CardDescription>
                    </CardHeader>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            <strong>
                                {deleteTarget
                                    ? DOKUMEN_LABELS[deleteTarget.jenis_dokumen]
                                    : ''}
                            </strong>
                            ? Kamu perlu upload ulang jika ingin menyertakannya.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <DialogClose asChild>
