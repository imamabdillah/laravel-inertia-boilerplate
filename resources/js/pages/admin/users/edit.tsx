...
import type { AdminUser, BreadcrumbItem, UnitRef } from '@/types';
...
export default function UserEdit({ user, roles, direktorats, upts }: Props) {
    ...
    const { data, setData, patch, processing, errors } = useForm({
        ...
        roles: user.roles ?? [],
        direktorat_id: user.direktorat_id ?? null,
        upt_id: user.upt_id ?? null,
